...
FICTION_GENRES = [
    "literary_fiction", "commercial_fiction", "mystery", "mystery_thriller", 
    "thriller", "romance", "fantasy", "epic_fantasy", "science_fiction", 
    "historical_fiction", "horror", "young_adult", "middle_grade", 
    "children_s_chapter_books", "speculative_fiction", "alternate_history", 
    "contemporary_fiction", "paranormal_romance", "urban_fantasy", "dystopian"
]

NON_FICTION_GENRES = [
    "memoir", "biography", "history", "self_help", "business", 
    "popular_science", "academic", "travel", "cookbook", "how_to", 
    "philosophy", "true_crime"
]

SPECIAL_FORMAT_GENRES = [
    "short_story_collection", "novella", "graphic_novel", 
    "essay_collection", "poetry_collection", "creative_non_fiction"
]
