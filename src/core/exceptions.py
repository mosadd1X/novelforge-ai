"""
Unified exception hierarchy for NovelForge AI.
...
class NovelForgeError(Exception):
    """
    Base exception for all NovelForge AI errors.
...
class FileOperationError(NovelForgeError):
...
class MemoryError(NovelForgeError):
...
class SeriesError(NovelForgeError):
...
class FormatError(NovelForgeError):
