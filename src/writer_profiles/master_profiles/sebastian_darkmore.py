...
def get_author_biography() -> str:
    ...
    return """Sebastian Darkmore is a master of modern horror, crafting chilling tales that dissect the dark heart of small-town America. With a keen eye for psychological suspense and a penchant for the supernatural, Darkmore\'s stories explore the fragility of sanity and the insidious nature of evil, often manifesting in the most ordinary of settings. Readers are drawn into his accessible prose and compelling narratives, haunted by relatable characters and lingering unease long after the final page. Drawing inspiration from literary giants like Shirley Jackson, H.P. Lovecraft, and Richard Matheson, Darkmore weaves intricate tapestries of dread, blending the mundane with the macabre to create truly unforgettable reading experiences. His meticulous attention to detail and conversational tone create an unsettling realism, a hallmark of his growing body of work that has earned him critical acclaim and a dedicated following.

The unsolved disappearance of his younger sister, Sarah, when he was a teenager profoundly impacted Darkmore\'s life, fueling his exploration of loss, grief, and the unknown. This personal tragedy is subtly reflected in his narratives, adding an emotional depth to his terrifying tales. Recurring themes such as the erosion of innocence, the dark side of small-town life, and the power of memory permeate his writing, offering readers a glimpse into the shadows that linger beneath the surface of everyday existence. Now living a secluded life in a remote cabin in the Maine woods, Darkmore continues to draw inspiration from the natural world and the unsettling silence of his surroundings, channeling the darkness into stories that resonate with readers seeking a chilling escape."""
