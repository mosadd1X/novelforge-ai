...
class TestModeManager:
    ...
    def enable_test_mode(self, level: str = "standard") -> None:
        ...
        os.environ["NOVELFORGE_AI_TEST_MODE"] = level
    ...
    def disable_test_mode(self) -> None:
        ...
        if "NOVELFORGE_AI_TEST_MODE" in os.environ:
            del os.environ["NOVELFORGE_AI_TEST_MODE"]

    @classmethod
    def is_test_mode_active(cls) -> bool:
        """Check if test mode is currently active."""
        return cls._test_mode_active or os.getenv("NOVELFORGE_AI_TEST_MODE") is not None

    @classmethod
    def get_test_mode_level(cls) -> Optional[str]:
        """Get the current test mode level."""
        return cls._test_mode_level or os.getenv("NOVELFORGE_AI_TEST_MODE")
